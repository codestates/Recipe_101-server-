...
export class new1621633400117 implements MigrationInterface {
    name = 'new1621633400117'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `food_info` (`id` int NOT NULL AUTO_INCREMENT, `foodName` varchar(255) NOT NULL, `summary` varchar(255) NOT NULL, `nation` varchar(255) NOT NULL, `type` varchar(255) NOT NULL, `cooking_time` varchar(255) NOT NULL, `calorie` varchar(255) NOT NULL, `qnt` varchar(255) NOT NULL, `level` varchar(255) NOT NULL, `IRDNT_code` varchar(255) NOT NULL, `price` varchar(255) NOT NULL, `img_url` varchar(255) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
