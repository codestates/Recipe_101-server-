...
export class new1621487994051 implements MigrationInterface {
    name = 'new1621487994051'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `recipe` (`id` int NOT NULL AUTO_INCREMENT, `cooking_no` int NOT NULL, `cooking_dc` varchar(255) NOT NULL, `step_image` varchar(255) NOT NULL, `step_tip` varchar(255) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `foodInfoId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `food_info` (`id` int NOT NULL AUTO_INCREMENT, `foodName` varchar(255) NOT NULL, `summary` varchar(255) NOT NULL, `nation` varchar(255) NOT NULL, `type` varchar(255) NOT NULL, `cooking_time` varchar(255) NOT NULL, `calorie` varchar(255) NOT NULL, `qnt` varchar(255) NOT NULL, `level` varchar(255) NOT NULL, `IRDNT_code` varchar(255) NOT NULL, `price` varchar(255) NOT NULL, `img_url` varchar(255) NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
